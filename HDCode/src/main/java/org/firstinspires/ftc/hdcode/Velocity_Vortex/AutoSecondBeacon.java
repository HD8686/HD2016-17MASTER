 ...
 */
public class AutoSecondBeacon implements HDAuto{
            ...
            switch (states){
                ...
                case shoot4:
                    if(elapsedTime > 27.0){
                        robot.driveHandler.motorBrake();
                        SM.resetValues();
                        SM.setState(State.raiseCollector);
                    }
                    robot.shooter.setFlywheelPower(0.33);
                ...
                case raiseCollector:
                    ...
                    break;
                case hitCap:
                    SM.setNextState(State.done, HDWaitTypes.Timer, 1.0);
                    robot.shooter.setFlywheelPower(0.0);
                    robot.shooter.setCollectorPower(0);
                    robot.shooter.setAcceleratorPower(0);
                    robot.shooter.raiseCollector();
                    robot.driveHandler.tankDrive(.5, .5);
                    break;
                case done:
                    SM.runOnce(new Runnable() {
                        @Override
