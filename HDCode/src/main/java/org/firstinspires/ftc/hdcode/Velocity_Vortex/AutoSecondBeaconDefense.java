 ...
 */
public class AutoSecondBeaconDefense implements HDAuto{
    ...
    public AutoSecondBeaconDefense(double delay, Alliance alliance){
            ...
            switch (states){
                ...
                case backUp:
                    if(comeBackToSecondBeacon){
                        ...
                        SM.setNextState(State.turnToCenter, HDWaitTypes.Timer, 0.8);
                    }
                ...
                case fastDriveToBeacon2:
                    ...
                    break;
                case turnToCenter:
                    if(robot.navX.getYaw() < 55){
                        robot.driveHandler.motorBrake();
                        SM.resetValues();
                        SM.setState(State.wait6);
                    }else{
                        robot.driveHandler.tankDrive(0.0,0.25);
                    }
                    break;
                case wait6:
                    SM.setNextState(State.driveToCenter, HDWaitTypes.Timer, 0.2);
                    robot.driveHandler.motorBrake();
                ...
                case shoot4:
                    ...
                    break;
                case raiseCollector:
                    SM.setNextState(State.driveToDefense, HDWaitTypes.Timer, 1.0);
                    ...
                    break;
                case driveToDefense:
                    SM.setNextState(State.done, HDWaitTypes.Timer, 1.8);
                    robot.driveHandler.mecanumDrive_Polar_keepFrontPos(.5 , 135, 135, robot.navX.getYaw());
                    break;
                case done:
                    SM.runOnce(new Runnable() {
                        @Override
